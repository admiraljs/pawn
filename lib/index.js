...
module.exports = class Pawn {
  ...
  constructor (name, program) {
    ...
    const hasRequiredSelf = module.children.length === 10
  ...
  _executeFromCli () {
    ...
    v8flags((err, flags) => {
      ...
      new Liftoff({ name: this.name, v8flags: flags }).launch(parsed, (env) => {
        ...
        pawn.execute(dargs(args, { allowCamelCase: true }).concat(parsed._))
      })
    })
  }
